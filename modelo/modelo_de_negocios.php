...
<body class="interno">
	...
	<div id="articulo">
			...
			<div id="introduccion">
				...
				<h1>Introducción al Modelo de Negocio del Proyecto Bit&amp;Nibs</h1>

				<h2>Objetivo:</h2>

				<p>El proyecto Bit&amp;Nibs nació bajo el contexto de un cambio de conciencia de época motivado por el nacimiento y propagación de las llamadas tecnologías disruptivas, tales como: la cadena de bloques, el bitcoin, las impresoras 3D y los contratos inteligentes, sólo por mencionar algunas.</p>

				<p>El proyecto Bit&amp;Nibs no se ha nutrido sólo de estas tecnologías, sino también de conceptos y movimientos originados por las nuevas formas de interacción de los usuarios con las tecnologías en el ámbito del internet. Conceptos como el <em>crowdsourcing</em>, prosumidores, <em>bootstraping</em> y <em>crowdfunding</em> nos han inspirado, y a la vez convencido de que el trabajo enfocado desde distintas perspectivas nos puede llevar a grandes logros.</p>

				<p>Este notorio cambio de conciencia en la sociedad nos motivó a crear un proyecto que no sólo incluyera todas las características deseables de una compañía de la era de la tercera revolución industrial, sino que además pudiera incluir la mayor cantidad de personas posibles, con el fin de permitirles generar valor y  poderlo proyectar dentro de una empresa en la que todo interesado se pueda sentir dueño.</p>
			 
				<p>Hoy día el mundo está viviendo uno de sus momentos más convulsos. Nos encontramos atrapados entre el miedo por la crisis económica y la esperanza depositada en las posibilidades que nos brindan las nuevas tecnologías.</p>

				<p>En este contexto, la solución más razonable es no dejarse llevar por el pánico, ni dejar que la incertidumbre nos paralice. De este modo, la solución comienza con la propuesta de un cambio para mejorar nuestras vidas y la de nuestros clientes.</p>

				<p>La estrategia principal del proyecto Bit&amp;Nibs es la distribución y venta de cacao latinoamericano en Europa. No obstante, tenemos plena confianza en poder crear un nuevo paradigma en la forma de hacer negocios, la cual pudiera ser aplicado a diversos sectores.</p>
			...
			<div id="quien">
				...
				<p>Quizá sea más sencillo empezar refiriéndonos a quién no va dirigida:</p>
			...
			<div id="segmentos">
				...
				<p>El proyecto pretende, por medio de la tecnología y el trabajo dedicado, curvar el espacio en el mercado, con el fin de acercar productores y consumidores.</p>

				<p>Para un proyecto que basa su modelo de negocio en la intermediación entre productor y consumidor, intentar acortar la distancia entre ellos podría parecer contraproducente,  sin embargo, otorga muchos beneficios que se traducen en una gran capacidad competitiva.</p> 

				<p>Por un lado aseguraríamos la fidelidad tanto del productor como del consumidor, pues al primero se le aseguraría mayores beneficios por su trabajo, y al segundo se le garantizaría la calidad y genuinidad del producto que consume.</p>

				<p>Desde este enfoque particular, tanto productor como consumidor son clientes, pues nuestra forma de participar en el ejercicio es a través de la retribución de comisiones, generadas en cada transacción efectuada.</p>
			...
			<div id="propuesta">
				...
				<p>Las organizaciones tradicionales de comercio justo no terminaron siendo lo justas que se esperaba. La opacidad de dichas organizaciones impidió demostrar la veracidad de aquello que proponían, y con el tiempo se fueron extendiendo sus  mentiras y corrupciones.</p> 
			...
			<div id="canales">
					...
					<p>Este aspecto es aún más importante cuando se trata de una empresa que se basa en la distribución y venta de productos creados por terceros.</p>
					<p>Es por eso que en nuestro modelo de negocios no escatimaremos en la exploración de diversas tipologías de canales, con el fin de llegar a desarrollar un canal propio y eficiente en las entregas.</p> 

					<p><strong>Canal directo:</strong></p>
						<p>Por medio de este tipo de canal buscaremos llegar al cliente mediante una interacción directa. Éste es más costoso para el cliente, pero también es el medio que asegura la obtención del feeedback del cliente de la mejor manera. Se puede entender como en el caso de un servicio que se genera desde nuestra página web, a partir del cual se utiliza el servicio de correo para entregar lo que el cliente adquirió.</p>

					<p><strong>Canal indirecto:</strong></p>
						<p>Este es el principal canal a desarrollar en el caso de chocolates artesanales, los cuales se venderían mejor en tiendas especializadas que desde nuestra página web. En este tipo de canal se contempla el fortalecimiento de la relación comercial con los prosumidores, los cuales podrían fácilmente convertirse en aliados locales para la distribución del producto.</p>

					<p><strong>Canales de Socios:</strong></p>
						<p>Dado el carácter "descentralizado" de la compañía, los dueños –accionistas- de esta se hallaran distribuidos en diferentes partes del mundo. Cada accionista tendrá la posibilidad (con privilegios) de distribuir regionalmente todos los productos con los que trabaja el proyecto en base a la conveniencia y cumplimiento de las normativas locales.</p> 

					<p>Todos los canales compartirán una estrategia de comunicación  en común, ya que  nuestra vía de promoción se dará principalmente a través de internet. Una vez el cliente interactúe con nuestra página web podrá evaluar con profundidad (y de manera entretenida) nuestra propuesta de valor.</p>
			...
			<div id="relaciones">
				...
				<p><strong>Asistencia Personal y asistencia personal exclusiva:</strong></p>
				<p>Es el tipo de relación que se establecerá con los clientes que requieran de una asesoría personalizada para realizar su compra. Ubicamos en este nivel a los clientes que adquieran nuestros productos para producir los suyos propios a gran escala.</p>

				<p><strong>Servicios automáticos:</strong></p>
				<p>El tipo de servicio surgirá de la interacción del cliente con la sección de venta de la página web.</p>

				<p><strong>Comunidades:</strong></p>
				<p>La página web se estructurará de modo que cada usuario pueda interactuar con el resto de los usuarios de la plataforma.</p>
			...
			<div id="actcl">
				...
				<p>Ofrecer a productores latinoamericanos de cacao y sus derivados, a través de una infraestructura propia y una red de servicios, la posibilidad de ubicar sus productos en el mercado europeo.</p> 
			...
			<div id="costos">
				...
				<p>La última parte no es la menos importante. La primera etapa del proyecto se basará en la creación de valor en términos de imagen y creación de un flujo de trabajo eficiente. Este enfoque nos permitirá asegurar un retorno de bonificaciones para  nuestros inversores, ya que estaremos creando valor a muy bajo precio. Incluso pagando a buen precio de mercado los servicios que podamos contratar en Venezuela, país en el que los rangos salariales son muy bajos.</p>

				<p id="fin">Para las siguientes etapas ya habremos creado una infraestructura de negocios que será capaz de aprovechar el potencial del mejor cacao que se cultiva y procesa en Venezuela.</p>  
				</div>
